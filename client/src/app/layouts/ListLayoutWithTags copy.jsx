                    ...
                    <article className="flex flex-col space-y-2 xl:space-y-0">
                      <dl>
                        ...
                        <dd className="text-base font-medium leading-6 text-gray-500 dark:text-gray-400">
                          <time datetime={new Date(post.createdAt).toLocaleDateString()}><PostDate date={post.createdAt} format="short" /></time>
                        </dd>
                      </dl>
                      <div className="space-y-3">
                        ...
                        {/* <div className="text-base font-medium leading-6">
                          <Link href={`/posts/${post._id}`} className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">Read more →</Link>
                        </div> */}
                      </div>
                    </article>
                  </li>
